...
void UpdateLegoCharacterAnimation(int *currentLego, int i)
{	
	if (gfTranslateLegoCharZ[i] <= -15.0f)
	{
		gfTranslateLegoCharZ[i] = gfTranslateLegoCharZ[i] + 0.075f;
		gfTranslateLegoNameZ[i] = gfTranslateLegoNameZ[i] + 0.08f;
	}
	else
	{
